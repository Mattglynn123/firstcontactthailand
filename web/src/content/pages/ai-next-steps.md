...
<section class="service-card-grid local-business-grid" aria-label="AI Next Steps">
  ...
  <article class="service-card">
    <img src="/assets/fct/business-ai-community.jpeg" alt="AI prompts for business" />
  ...
  <article class="service-card">
    <img src="/assets/fct/business-coworking.jpg" alt="AI business areas" />
  ...
  <article class="service-card">
    <img src="/assets/fct/business-marketing.jpg" alt="Choosing AI software" />
  ...
  <article class="service-card">
    <img src="/assets/fct/start-up-scaled.jpg" alt="Getting started with AI" />
  ...
  <article class="service-card">
    <img src="/assets/fct/remote-scaled.jpg" alt="Connecting business tools with AI" />
  ...
  <article class="service-card">
    <img src="/assets/fct/marketing-media.jpg" alt="AI for marketing" />
  ...
  <article class="service-card">
    <img src="/assets/fct/business-done-4-u.jpg" alt="AI agents review service" />
  ...
  <article class="service-card">
    <img src="/assets/fct/b.networking-scaled.jpg" alt="AI planning" />
    <h2>AI Planning</h2>
    <p>Use AI to turn goals, ideas, and business problems into clear plans, actions, checklists, and next steps.</p>
  </article>
  <article class="service-card">
    <img src="/assets/fct/business-ai-community.jpeg" alt="AI business startup pack" />
  ...
  <article class="service-card">
    <img src="/assets/fct/business-marketing.jpg" alt="AI and Meta platforms" />
