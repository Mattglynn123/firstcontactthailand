...
export const priorityPages: Record<string, PriorityPage> = {
  ...
  'ai-next-steps': {
    ...
    heroImage: '/assets/fct/ai-next-steps/ai-basic-tutorials.jpg',
    gridColumns: 4,
    cards: [
      { title: 'Basic AI Tutorials', text: 'Simple beginner-friendly sessions that explain what AI can do and how to use it in everyday business tasks.', image: '/assets/fct/ai-next-steps/ai-basic-tutorials.jpg' },
      { title: 'Twenty AI Prompts That Will Help You', text: 'A practical set of prompts for planning, writing, customer service, marketing, admin, and business problem solving.', image: '/assets/fct/business-ai-community.jpeg' },
      { title: 'Using AI Across Separate Business Areas', text: 'Ways to split your business into clear areas such as sales, admin, marketing, operations, finance, and customer support.', image: '/assets/fct/business-coworking.jpg' },
      { title: 'Which AI Software To Use', text: 'Plain-English guidance on choosing the right AI tools for your business needs, budget, and confidence level.', image: '/assets/fct/business-marketing.jpg' },
      { title: 'How To Get Started With AI As A Beginner', text: 'A clear first-step route for business owners who want to start using AI without feeling overloaded.', image: '/assets/fct/start-up-scaled.jpg' },
      { title: 'Connecting Existing Business Tools Using AI', text: 'Ideas for connecting tools such as WhatsApp, Google Drive, Excel, documents, forms, and customer messages.', image: '/assets/fct/remote-scaled.jpg' },
      { title: 'AI For Marketing', text: 'Use AI to plan campaigns, write better posts, create content ideas, improve offers, and save time on promotion.', image: '/assets/fct/marketing-media.jpg' },
      { title: 'Types Of AI Tools', text: 'An overview of AI tools for text, voice, images, video, research, automation, customer support, and business planning.', image: '/assets/fct/ai-next-steps/ai-tool-types.jpg' },
      { title: 'Understanding Basic Agents And Agent Review', text: 'Understand what simple AI agents are, what they can safely do, and how an agent review service could help.', image: '/assets/fct/business-done-4-u.jpg' },
      { title: 'AI Planning', text: 'Use AI to turn goals, ideas, and business problems into clear plans, actions, checklists, and next steps.', image: '/assets/fct/b.networking-scaled.jpg' },
      { title: 'AI Business Start Up Pack', text: 'A starter pack for using AI in a new or growing business, including core tools, workflows, and useful prompts.', image: '/assets/fct/business-insurance.jpg' },
      { title: 'How AI Can Help With Business Pain Points', text: 'Identify time drains, repeated admin, customer service gaps, content bottlenecks, and other areas AI can support.', image: '/assets/fct/ai-next-steps/ai-business-pain-points.jpg' },
      { title: 'How AI Can Work With Meta', text: 'Explore how AI can support Facebook, Instagram, ads, customer messages, content planning, and community engagement.', image: '/assets/fct/ai-next-steps/ai-meta-marketing.jpg' },
      { title: 'AI For Good', text: 'Ideas for using AI to support job creation, myth busting, community education, and positive local projects.', image: '/assets/fct/ai-next-steps/ai-for-good.jpg' },
      { title: 'How To Work AI With APIs', text: 'A practical introduction to using APIs so AI tools can connect with data, websites, apps, and business systems.', image: '/assets/fct/ai-next-steps/ai-api-workflows.jpg' },
      { title: 'Safety, Data Security And Protection', text: 'Understand what information to protect, what not to share, and how to use AI more safely in business.', image: '/assets/fct/ai-next-steps/ai-data-security.jpg' },
      { title: 'Samui Business Start Up Checklist', text: 'A practical Samui business checklist that can be converted into different languages for local and expat users.', image: '/assets/fct/ai-next-steps/ai-samui-checklist.jpg' },
      { title: 'Server Setup For AI', text: 'Advanced support for businesses that need hosting, servers, integrations, automation, or more technical AI systems.', image: '/assets/fct/ai-next-steps/ai-server-setup.jpg' },
    ],
    ctaLabel: 'Ask about AI support for your business',
    ctaHref: '/contact-link/?topic=AI%20Next%20Steps',
    ctaImage: true,
  },
  'community-events': {
  ...
  'health-fitness': {
    ...
    heroText: 'Looking to get fit and meet new people? Caught in the pub circuit a bit too often and ready to shed a few kilos?',
    heroImage: '/assets/fct/beach-1-scaled.jpg',
    gridColumns: 3,
    cards: [
      { title: "Womens Health & Wellness", text: "Several amazing events are held weekly to support womens health. Some of our members also offer a range of womens health products.", image: '/assets/fct/gym-scaled.jpg', href: '/contact-link/?topic=Womens%20Health%20and%20Wellness', action: 'Click here to discover womens health and wellness events and program' },
  ...
  'tours-2': {
    ...
    cards: [
      ...
      { title: 'Full Moon Parties', text: 'Safe, stylish Full Moon Party experiences arranged around your group with trusted local support.', image: '/assets/fct/1-scaled.jpg', href: '/assets/fct/full-moon-party-vip-trip-31-july-2026.png', action: 'Book your Full Moon trip' },
