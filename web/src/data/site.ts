...
export const priorityPages: Record<string, PriorityPage> = {
  ...
  'community-events': {
    ...
    cards: [
      { title: 'AI Community Meetups', text: 'Practical conversations for people exploring AI tools, local projects and new business ideas.', image: '/assets/fct/ai-community-meeting.jpeg', meta: 'Koh Samui', href: '/event/ai-community-meeting-nature-bar-maenam-weekly-2026-07-22/', action: 'View event' },
      { title: 'Friday Business Lunch', text: 'A relaxed weekly gathering for introductions, referrals and useful local collaboration.', image: '/assets/fct/friday-business-networking-lunch.png', meta: 'Weekly networking', href: '/event/business-networking-lunch-nature-bar-maenam-weekly-2026-07-24/', action: 'View event' },
      ...
      { title: 'Pub Quiz', text: 'An easy social evening for teams, visitors and locals who enjoy a friendly challenge.', image: '/assets/fct/pub-quiz-nature-bar.jpeg', meta: 'Social event', href: '/event/pub-quiz-nature-bar-maenam-beach-weekly-2026-07-23/', action: 'View event' },
      { title: 'Beach Walks & Gatherings', text: 'Simple outdoor events for meeting people and staying connected with the community.', image: '/assets/fct/beach-walk-community.jpg', meta: 'Community activity', href: '/event/beach-walk-koh-samui-weekly-2026-07-18/', action: 'View event' },
