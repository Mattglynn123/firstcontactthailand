...
export const priorityPages: Record<string, PriorityPage> = {
  'local-business-network': {
    ...
    cards: [
      ...
      { title: 'Property Support', text: 'Connect with trusted property sales, management, building, and buyer support.', image: '/assets/fct/b.networking-scaled.jpg', href: '/real-estate/', action: 'Explore property support' },
      ...
      { title: 'Tours & Entertainment', text: 'Find trusted tours, local experiences, entertainment, and event partners.', image: '/assets/fct/Hero-Images-copy-2-scaled.jpg', href: '/tours-2/', action: 'Explore tours' },
  ...
  'local-deals': {
    ...
    gridColumns: 3,
    cards: [
      { title: 'Drink Like a Local', text: 'Hate paying tourist prices? We will guide you straight to the best local happy hours and insider specials.', image: '/assets/fct/photo-1514362545857-3bc16c4c7d1b.avif', href: '/contact-link/?fct_service=local-deals', action: 'Find local deals' },
      { title: 'Eat Like a Local', text: 'Hate paying tourist prices? We will show you where the locals eat, drink, and celebrate.', image: '/assets/fct/photo-1555396273-367ea4eb4db5.avif', href: '/contact-link/?fct_service=local-deals', action: 'Find local deals' },
      { title: 'Live Like a Local', text: 'Discover how to shop, eat, travel, and enjoy Thailand at local rates with trusted local recommendations.', image: '/assets/fct/photo-1504674900247-0877df9cc836.avif', href: '/contact-link/?fct_service=local-deals', action: 'Find local deals' },
    ],
  },
  'health-fitness': {
    slug: 'health-fitness',
